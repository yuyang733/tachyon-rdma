...
import tachyon.JXIO.xio_RemoteBlockInStreamClient;
...
/**
 * 修改内容：重写retriveByteBufferFromRemoteMachine这个函数
 * 修改人：YuYang
 * 修改时间：2014/10/04
 * 注意事项: NULL
 */
...
*/
    /**
     * name：retrieveByteBufferFromRemoteMachine
     * @param address
     * @param blockId
     * @param offset
     * @param length
     * @return
     * @throws IOException
     * 修改内容：用JXIO重写retrieveByteBufferFromRemoteMachine函数的实现
     * 修改人：YuYang
     * 修改时间：2014/10/05
     * 注意事项: null
     */
...
private ByteBuffer retrieveByteBufferFromRemoteMachine(InetSocketAddress address, long blockId,
                                                           long offset, long length) throws IOException{
    xio_RemoteBlockInStreamClient client = xio_RemoteBlockInStreamClient.getInstance();
    ByteBuffer recvData = client.ReadBlockFromRemoteMachine(address,blockId,offset,length);
